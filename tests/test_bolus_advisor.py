"""Tests for the BolusAdvisor-v0 environment."""
...
class TestBolusAdvisorEnv:
    ...
    def test_action_space(self):
        ...
        assert env.action_space.high[0] == pytest.approx(20.0)
        env.close()
    ...
    def test_difficulty_options(self):
        for d in ["easy", "medium", "hard"]:
            env = gym.make("glucosim/BolusAdvisor-v0", difficulty=d)
